...
def _install_rc3_overrides() -> None:
    # Legacy MainWindow methods resolve these imported names at runtime. Patching
    # the module globals lets RC3 remain a thin, reviewable overlay over RC2.
...
class MainWindow(RC2MainWindow):
    ...
    def __init__(self, *args: object, **kwargs: object) -> None:
        ...
        # RC2 already replaced the delayed, not-yet-started worker once. Replace
        # it again before the startup gate fires so new packages use the RC3
        # comment-aware publishers while keeping the same managed Drive cleanup.
