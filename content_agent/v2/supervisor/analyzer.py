...
Правила причинності: PUBLISH_FAILURES є агрегатом за 24 години і НЕ пов'язуй його з поточним AI-збоєм без окремого доказу. Log-tail/RETRY_STORM є лише недавнім журналом, а не автоматично активною причиною. Якщо OpenRouter має finish_reason=length або іншу відповідь від моделі, не називай модель «недоступною»: вона відповіла, але не завершила корисний content. Старі RCxx у назві Python-модуля/логера не означають, що запущена стара версія програми. Відокремлюй поточний збій від історичних/агрегованих симптомів.
EVENT: {event}
