...
_NUMBER_RE = re.compile(
    ...
    r"km(?![a-zа-яіїєґ])|км(?![a-zа-яіїєґ])|кілометр(?:и|ів|а|у|ом|ами|ах)?|километр(?:ы|ов|а|у|ом|ами|ах)?|kilometers?|kilometres?|метр(?:и|ів|а|у|ом|ами|ах)?|метр(?:ы|ов|а|у|ом|ами|ах)?|meters?|metres?|кілограм(?:и|ів|а|у|ом|ами|ах)?|килограмм?(?:ы|ов|а|у|ом|ами|ах)?|kilograms?|мегават(?:и|ів|а|у|ом|ами|ах)?|мегаватт?(?:ы|ов|а|у|ом|ами|ах)?|megawatts?|гігават(?:и|ів|а|у|ом|ами|ах)?|гигаватт?(?:ы|ов|а|у|ом|ами|ах)?|gigawatts?|гігабайт(?:и|ів|а|у|ом|ами|ах)?|гигабайт(?:ы|ов|а|у|ом|ами|ах)?|gigabytes?|мегабайт(?:и|ів|а|у|ом|ами|ах)?|мегабайт(?:ы|ов|а|у|ом|ами|ах)?|megabytes?|терабайт(?:и|ів|а|у|ом|ами|ах)?|терабайт(?:ы|ов|а|у|ом|ами|ах)?|terabytes?|"
    r"kg(?![a-zа-яіїєґ])|кг(?![a-zа-яіїєґ])|"
...
_UNIT_WORD_PATTERNS: tuple[tuple[re.Pattern[str], str], ...] = (
    (re.compile(r"(?iu)^(?:кілометр(?:и|ів|а|у|ом|ами|ах)?|километр(?:ы|ов|а|у|ом|ами|ах)?|kilometers?|kilometres?)$"), "km"),
    (re.compile(r"(?iu)^(?:метр(?:и|ів|а|у|ом|ами|ах)?|метр(?:ы|ов|а|у|ом|ами|ах)?|meters?|metres?)$"), "m"),
    (re.compile(r"(?iu)^(?:кілограм(?:и|ів|а|у|ом|ами|ах)?|килограмм?(?:ы|ов|а|у|ом|ами|ах)?|kilograms?)$"), "kg"),
    (re.compile(r"(?iu)^(?:мегават(?:и|ів|а|у|ом|ами|ах)?|мегаватт?(?:ы|ов|а|у|ом|ами|ах)?|megawatts?)$"), "mw"),
    (re.compile(r"(?iu)^(?:гігават(?:и|ів|а|у|ом|ами|ах)?|гигаватт?(?:ы|ов|а|у|ом|ами|ах)?|gigawatts?)$"), "gw"),
    (re.compile(r"(?iu)^(?:гігабайт(?:и|ів|а|у|ом|ами|ах)?|гигабайт(?:ы|ов|а|у|ом|ами|ах)?|gigabytes?)$"), "gb"),
    (re.compile(r"(?iu)^(?:мегабайт(?:и|ів|а|у|ом|ами|ах)?|мегабайт(?:ы|ов|а|у|ом|ами|ах)?|megabytes?)$"), "mb"),
    (re.compile(r"(?iu)^(?:терабайт(?:и|ів|а|у|ом|ами|ах)?|терабайт(?:ы|ов|а|у|ом|ами|ах)?|terabytes?)$"), "tb"),
)
