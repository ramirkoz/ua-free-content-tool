...
from .database_v1_4_rc4 import Database
...
from .ui.v1_4_rc7_window import MainWindow
...
def _run_ui_startup(root: tk.Tk, logger: object) -> int:
    root.title("UA FREE Content Tool — v1.4.0-rc7 · запуск")
    ...
    ttk.Label(frame, text="UA FREE Content Tool v1.4.0-rc7", font="TkHeadingFont").pack(anchor="w")
    ...
    def poll_result() -> None:
        ...
        try:
            ...
            stop_watchdog.set()
            logger.error("Application UI startup failed: %s", exc)  # type: ignore[attr-defined]
