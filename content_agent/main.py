...
from .database_rc14 import Database
...
from .ui.rc14_window import MainWindow
...
def _run_ui_startup(root: tk.Tk, logger: object) -> int:
    root.title("UA FREE Content Tool — v1.3.1-rc14 · запуск")
    ...
    ttk.Label(frame, text="UA FREE Content Tool v1.3.1-rc14", font="TkHeadingFont").pack(anchor="w")
