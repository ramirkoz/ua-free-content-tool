...
from .database_v1_4_rc14 import Database
...
from .ui.v1_4_rc14_window import MainWindow
...
def _run_ui_startup(root: tk.Tk, logger: object) -> int:
    root.title("UA FREE Content Tool — v1.4.0-rc14 · запуск")
    ...
    ttk.Label(frame, text="UA FREE Content Tool v1.4.0-rc14", font="TkHeadingFont").pack(anchor="w")
