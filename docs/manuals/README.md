...
The PDFs are generated reproducibly from the repository documentation and the validated Ukrainian documentation snapshot by the `Build setup manuals` GitHub Actions workflow.
