...
- Visible application naming is consistently `UA FREE Content Tool v1.3.1-rc12`; historical `dev`/internal build labels are not shown.

See [RELEASE_NOTES_v1.3.1-rc12.md](RELEASE_NOTES_v1.3.1-rc12.md).
...
2. For this candidate, use `UA_FREE_Content_Tool_v1.3.1-rc12_Windows_Portable.zip`.
...
The public v1.3.0 release remains the stable baseline. v1.3.1-rc12 is the current live candidate built on the same signed portable runtime; its global-search and Router changes are covered by targeted deterministic tests, while final Windows/Data acceptance is performed on the operator workstation.

## Documentation

- [RELEASE_NOTES_v1.3.1-rc12.md](RELEASE_NOTES_v1.3.1-rc12.md) — current candidate notes.
